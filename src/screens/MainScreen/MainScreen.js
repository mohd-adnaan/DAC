...
//             <Marker coordinate={selectedCoordinate} pinColor="newColor" />
//           )}
...
//                 >
//                  <Text style={styles.modalButtonText}>Update Marked Location</Text>
//                 </TouchableOpacity>
...
//     <Text style={styles.footerText2}>{footerText}</Text>
//   </View>
//       )}
...
//             Current Location :  {mLat !== null ? mLat.toFixed(4) : 28.6139},{' '}
//             {mLong !== null ? mLong.toFixed(4) : 77.209}
//           </Text>
          
//           {markedLocation && <Text style={styles.markedLocationText}>
//                 Marked Location :  {markedLocation.latitude.toFixed(4)},{' '}
...
>
  ...
  {boundaryMarkers.map((marker, index) => (
