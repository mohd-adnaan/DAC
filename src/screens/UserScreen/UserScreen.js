      ...
      <View style={{ marginTop: '10%' }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: '5%', width: '90%' }}>
          <MaterialIcons
            ...
            size={40}
            color="#9AC5F4" />
          <Text style={{ color: '#000000', fontSize: 24, alignSelf: 'center', marginBottom: '2%', marginLeft :20}}>{designation}</Text>
        </View>
        ...
        <View style={{ flexDirection: 'row', marginTop: '5%', width: '90%' }}>
          <MaterialIcons
            ...
            size={44}
            color="#9AC5F4" />
          <Text style={{ color: '#000000', fontSize: 24, alignSelf: 'center', marginBottom: '2%',marginLeft:25 }}>{department}</Text>
        </View>
